      ...
      >
        <div className='w-1/2 flex flex-col justify-between items-start px-12 pt-12 pb-2' >
          <div className="relative z-10 ">
            <p className='text-[32px] font-semibold text-left'>Strategy and Blueprint</p>
            <p className='text-[18px] py-8 text-left max-w-[600px]'>Turning insights into a strategic framework. We design the system before we design the pixels.</p>
          </div>
