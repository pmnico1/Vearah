      ...
      >
        <div className='w-1/2 flex flex-col justify-between items-start px-12 pt-12 pb-2'>
          <div className="relative z-10">
            <p className='text-[32px] font-semibold text-left'>{title}</p>
            <p className='text-[18px] py-8 text-left max-w-[600px]'>{description}</p>
          </div>
          <p className='text-[40px]'>{stepNumber}</p>
        </div>
        <Image
          src={imageSrc}
          className='w-1/2 object-cover overflow-hidden rounded-l-[40px] z-30'
          alt={imageAlt}
          width={500}
          height={500}
        />
