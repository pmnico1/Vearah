...
export default function Keyboard() {
  ...
  return (
    <div className="relative flex flex-col items-center space-y-8">
      ...
      <div className="max-w-[700px] h-[100px] text-white text-[48px] mb-[295px] text-center font-medium leading-14 tracking-[0.32rem] ">
      ...
      <div ref={keyboardContainerRef} className='border-t-[2px] rounded-2xl border-zinc-800 w-full md:w-fit overflow-hidden opacity-0'>
        <div
          className="rounded-2xl px-6 pt-10 pb-40 shadow-2xl border  border-zinc-950 "
        >
