...
const tagPositions = [
  { key: 'top', className: '-top-[7vh] left-1/2 transform -translate-x-1/2', delay: 0.1 },
  { key: 'left1', className: 'top-[10vh] -left-[15%]', delay: 0.2 },
  { key: 'left2', className: 'top-[25vh] -left-[20%]', delay: 0.3 },
  { key: 'right1', className: 'top-[12vh] -right-[15%]', delay: 0.15 },
  { key: 'right2', className: 'top-[27vh] -right-[20%]', delay: 0.25 },
];
